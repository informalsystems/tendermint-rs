...
/\ blockchain = 1
    :> [NextVS |-> { "n2", "n6", "n7", "n8" },
      ...
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n8", "n9" },
      VS |-> { "n2", "n6", "n7", "n8" },
      height |-> 2,
      lastCommit |-> { "n1", "n10", "n2", "n3", "n5", "n6", "n7", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n2", "n3", "n4", "n5", "n7", "n8", "n9" },
      VS |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n8", "n9" },
      height |-> 3,
      lastCommit |-> { "n6", "n7", "n8" },
      time |-> 4]
  @@ 4
    :> [NextVS |->
      ...
      VS |-> { "n1", "n2", "n3", "n4", "n5", "n7", "n8", "n9" },
      height |-> 4,
      lastCommit |-> { "n1", "n2", "n3", "n4", "n8", "n9" },
      time |-> 5]
...
/\ fetchedLightBlocks = 1
  ...
  @@ 4
    :> [Commits |-> { "n6", "n9" },
      header |->
        [NextVS |-> { "n1", "n4", "n5", "n6", "n7", "n8" },
          VS |-> { "n6", "n9" },
          height |-> 4,
          lastCommit |-> { "n10", "n2", "n4", "n5", "n7" },
          time |-> 3]]
/\ history = 0
    :> [current |->
        [Commits |->
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n2", "n6", "n7", "n8" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n6", "n7", "n8" },
  header |->
    [NextVS |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n8", "n9" },
      VS |-> { "n2", "n6", "n7", "n8" },
      height |-> 2,
  ...
  Cardinality((DOMAIN fetchedLightBlocks)) = 3
    /\ BMC!Skolem((\E s1$2 \in DOMAIN history:
      BMC!Skolem((\E s2$2 \in DOMAIN history:
        s2$2 = s1$2 + 1
          /\ LET t_33 == history[s1$2]["current"]["header"]["VS"] IN
          BMC!Skolem((\E t_31 \in t_33:
            BMC!Skolem((\E t_32 \in t_33: ~(t_31 = t_32)))))
          /\ Cardinality(history[s2$2]["current"]["header"]["VS"])
            = 2 * Cardinality(history[s1$2]["current"]["header"]["VS"])))))

================================================================================
\* Created by Apalache on Wed Nov 18 13:57:44 UTC 2020
