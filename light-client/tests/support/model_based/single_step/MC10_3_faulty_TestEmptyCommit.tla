...
/\ blockchain = 1
    :> [NextVS |-> { "n5", "n6" },
      ...
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n10", "n2", "n3", "n4", "n7", "n8" },
      VS |-> { "n5", "n6" },
      height |-> 2,
      lastCommit |-> { "n1", "n10", "n3", "n4", "n6", "n7", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n10", "n2", "n4", "n5", "n6", "n7", "n8", "n9" },
      VS |-> { "n1", "n10", "n2", "n3", "n4", "n7", "n8" },
      height |-> 3,
      lastCommit |-> { "n5", "n6" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
      ...
      VS |-> { "n1", "n10", "n2", "n4", "n5", "n6", "n7", "n8", "n9" },
      height |-> 4,
    ...
    :> [Commits |-> {},
      header |->
        [NextVS |-> {},
          VS |-> { "n10", "n2", "n3", "n6", "n9" },
          height |-> 3,
          lastCommit |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n7", "n8" },
          time |-> 3]]
/\ history = 0
    :> [current |->
        [Commits |->
...
================================================================================
\* Created by Apalache on Tue Oct 20 11:34:38 CEST 2020
