...
/\ blockchain = 1
  ...
  @@ 2
    :> [NextVS |-> { "n2", "n5", "n7", "n9" },
      VS |-> { "n2", "n3", "n4", "n5", "n7", "n8", "n9" },
      height |-> 2,
      lastCommit |-> { "n10", "n2", "n3", "n4", "n6", "n7", "n8", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      VS |-> { "n2", "n5", "n7", "n9" },
      height |-> 3,
      lastCommit |-> { "n3", "n4", "n7", "n8", "n9" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
        { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      VS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      height |-> 4,
      lastCommit |-> { "n2", "n5", "n7", "n9" },
      time |-> 4]
...
/\ now = 4
/\ nprobes = 1
/\ prevCurrent = [Commits |-> { "n5", "n8" },
  header |->
    [NextVS |-> { "n2", "n5" },
      VS |-> { "n3", "n6" },
      height |-> 4,
      lastCommit |-> { "n1", "n10", "n2", "n3", "n4", "n6", "n7", "n8", "n9" },
      time |-> 5]]
/\ prevNow = 4
/\ prevVerdict = "INVALID"
/\ prevVerified = [Commits |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
...
================================================================================
\* Created by Apalache on Fri Nov 06 10:03:52 UTC 2020
