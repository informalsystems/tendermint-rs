...
/\ blockchain = 1
    :> [NextVS |-> { "n10", "n2", "n3", "n4", "n5", "n7", "n8" },
      ...
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n2", "n3", "n4", "n5", "n7", "n8" },
      VS |-> { "n10", "n2", "n3", "n4", "n5", "n7", "n8" },
      height |-> 2,
      lastCommit |-> { "n2", "n3", "n4", "n5", "n6", "n7", "n8" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n10", "n3", "n8" },
      VS |-> { "n2", "n3", "n4", "n5", "n7", "n8" },
      height |-> 3,
      lastCommit |-> { "n10", "n3", "n4", "n5", "n8" },
      time |-> 4]
  @@ 4
    :> [NextVS |->
...
================================================================================
\* Created by Apalache on Fri Nov 06 10:04:30 UTC 2020
