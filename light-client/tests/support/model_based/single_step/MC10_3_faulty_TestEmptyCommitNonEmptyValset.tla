...
/\ Faulty = { "n2", "n8", "n9" }
/\ blockchain = 1
    :> [NextVS |-> { "n1", "n10", "n4", "n5", "n6", "n7", "n8", "n9" },
      VS |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      height |-> 1,
      lastCommit |-> {},
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n10", "n3", "n4", "n5", "n8", "n9" },
      VS |-> { "n1", "n10", "n4", "n5", "n6", "n7", "n8", "n9" },
      height |-> 2,
      lastCommit |-> { "n1", "n3", "n4", "n5", "n6", "n7", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n3", "n4", "n8" },
      VS |-> { "n1", "n10", "n3", "n4", "n5", "n8", "n9" },
      height |-> 3,
      lastCommit |-> { "n1", "n10", "n4", "n5", "n8", "n9" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
    ...
    :> [Commits |-> {},
      header |->
        [NextVS |-> { "n2", "n3" },
          VS |-> {"n1"},
          height |-> 3,
          lastCommit |-> { "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8" },
          time |-> 3]]
/\ history = 0
    :> [current |->
        [Commits |->
...
================================================================================
\* Created by Apalache on Thu Oct 22 14:32:26 CEST 2020
