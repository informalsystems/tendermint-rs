...
/\ blockchain = 1
    :> [NextVS |-> { "n1", "n10", "n4", "n5", "n6", "n8", "n9" },
      ...
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n2", "n3", "n4", "n7", "n8" },
      VS |-> { "n1", "n10", "n4", "n5", "n6", "n8", "n9" },
      height |-> 2,
      lastCommit |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n10", "n4", "n5", "n7" },
      VS |-> { "n1", "n2", "n3", "n4", "n7", "n8" },
      height |-> 3,
...
InvariantViolation ==
  BMC!Skolem((\E s$2 \in DOMAIN history:
      ...
      LET TVS$2 == history[s$2]["verified"]["header"]["VS"] IN
      history[s$2]["current"]["header"]["height"]
          > history[s$2]["verified"]["header"]["height"] + 1
        /\ ~(CMS$2 = {} <: {STRING})
...
================================================================================
\* Created by Apalache on Fri Nov 06 10:03:33 UTC 2020
