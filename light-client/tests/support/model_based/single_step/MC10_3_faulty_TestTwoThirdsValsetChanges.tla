...
/\ blockchain = 1
  ...
  @@ 2
    :> [NextVS |-> { "n10", "n3", "n8", "n9" },
      VS |-> { "n4", "n6" },
      height |-> 2,
      lastCommit |-> { "n1", "n10", "n3", "n4", "n5", "n6", "n7", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n2", "n3", "n4", "n8", "n9" },
      VS |-> { "n10", "n3", "n8", "n9" },
      height |-> 3,
      lastCommit |-> { "n4", "n6" },
      time |-> 3]
...
/\ fetchedLightBlocks = 1
  ...
  @@ 3
    :> [Commits |-> { "n1", "n5", "n8" },
      header |->
        [NextVS |-> { "n2", "n4", "n5", "n6", "n9" },
          VS |-> { "n1", "n5", "n8" },
          height |-> 3,
          lastCommit |-> { "n2", "n4", "n5", "n8", "n9" },
          time |-> 2]]
/\ history = 0
    :> [current |->
        [Commits |->
...
================================================================================
\* Created by Apalache on Tue Oct 20 10:28:06 CEST 2020
