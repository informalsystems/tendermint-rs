...
/\ Faulty = {"n3"}
/\ blockchain = 1
    :> [NextVS |-> { "n2", "n3", "n4", "n6", "n9" },
      VS |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      height |-> 1,
      lastCommit |-> {},
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n10", "n2", "n4", "n7" },
      VS |-> { "n2", "n3", "n4", "n6", "n9" },
      height |-> 2,
      lastCommit |-> { "n1", "n3", "n5", "n6", "n7", "n8", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n10", "n2", "n4", "n6", "n8" },
      VS |-> { "n1", "n10", "n2", "n4", "n7" },
      height |-> 3,
      lastCommit |-> { "n2", "n3", "n4", "n6", "n9" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
...
/\ now = 1400
/\ nprobes = 1
/\ prevCurrent = [Commits |-> { "n1", "n10", "n2", "n7" },
  header |->
    [NextVS |-> { "n10", "n2", "n4", "n6", "n8" },
      VS |-> { "n1", "n10", "n2", "n4", "n7" },
      height |-> 3,
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n2", "n3", "n4", "n6", "n9" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n3", "n4", "n6", "n9" },
  header |->
    [NextVS |-> { "n1", "n10", "n2", "n4", "n7" },
      VS |-> { "n2", "n3", "n4", "n6", "n9" },
      height |-> 2,
...
/\ now = 1400
/\ nprobes = 2
/\ prevCurrent = [Commits |-> { "n3", "n4", "n6", "n9" },
  header |->
    [NextVS |-> { "n1", "n10", "n2", "n4", "n7" },
      VS |-> { "n2", "n3", "n4", "n6", "n9" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Wed Nov 18 13:57:59 UTC 2020
