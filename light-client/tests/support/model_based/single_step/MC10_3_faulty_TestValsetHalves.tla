...
/\ blockchain = 1
    :> [NextVS |-> { "n10", "n2", "n3", "n6" },
      ...
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n2", "n4", "n6", "n9" },
      VS |-> { "n10", "n2", "n3", "n6" },
      height |-> 2,
      lastCommit |-> { "n10", "n2", "n3", "n4", "n5", "n6", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n2", "n3", "n4", "n6", "n7", "n8" },
      VS |-> { "n1", "n2", "n4", "n6", "n9" },
      height |-> 3,
      lastCommit |-> { "n10", "n2", "n3" },
      time |-> 4]
  @@ 4
    :> [NextVS |->
        { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      VS |-> { "n1", "n2", "n3", "n4", "n6", "n7", "n8" },
      height |-> 4,
      lastCommit |-> { "n1", "n2", "n4", "n6" },
      time |-> 5]
...
/\ now = 1400
/\ nprobes = 1
/\ prevCurrent = [Commits |-> { "n1", "n4", "n6", "n9" },
  header |->
    [NextVS |-> { "n1", "n2", "n3", "n4", "n6", "n7", "n8" },
      VS |-> { "n1", "n2", "n4", "n6", "n9" },
      height |-> 3,
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n10", "n2", "n3", "n6" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n10", "n2", "n3" },
  header |->
    [NextVS |-> { "n1", "n2", "n4", "n6", "n9" },
      VS |-> { "n10", "n2", "n3", "n6" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Thu Oct 22 13:14:03 CEST 2020
