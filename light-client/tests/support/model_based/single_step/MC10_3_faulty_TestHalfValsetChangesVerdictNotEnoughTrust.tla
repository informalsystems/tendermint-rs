...
/\ blockchain = 1
  ...
  @@ 2
    :> [NextVS |-> { "n1", "n10", "n2", "n3", "n5", "n6", "n7" },
      VS |-> { "n1", "n10", "n3", "n6" },
      height |-> 2,
      lastCommit |-> { "n10", "n2", "n3", "n4", "n7", "n8", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n2", "n3", "n4", "n5", "n6", "n7" },
      VS |-> { "n1", "n10", "n2", "n3", "n5", "n6", "n7" },
      height |-> 3,
      lastCommit |-> { "n1", "n10", "n3" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
        { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      VS |-> { "n1", "n2", "n3", "n4", "n5", "n6", "n7" },
      height |-> 4,
      lastCommit |-> { "n10", "n2", "n3", "n5", "n6" },
      time |-> 4]
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n1", "n10", "n3", "n6" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n10", "n3", "n6" },
  header |->
    [NextVS |-> { "n1", "n10", "n2", "n3", "n5", "n6", "n7" },
      VS |-> { "n1", "n10", "n3", "n6" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Thu Oct 22 13:13:45 CEST 2020
