...
/\ blockchain = 1
  ...
  @@ 2
    :> [NextVS |-> { "n2", "n3", "n5", "n8" },
      ...
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n1", "n10", "n2", "n6", "n7" },
      VS |-> { "n2", "n3", "n5", "n8" },
      height |-> 3,
      lastCommit |-> { "n10", "n6", "n8" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n10", "n4", "n6", "n8" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n10", "n4", "n6", "n8" },
  header |->
    [NextVS |-> { "n2", "n3", "n5", "n8" },
      VS |-> { "n10", "n4", "n6", "n8" },
      height |-> 2,
...
/\ now = 1400
/\ nprobes = 2
/\ prevCurrent = [Commits |-> { "n10", "n4", "n6", "n8" },
  header |->
    [NextVS |-> { "n2", "n3", "n5", "n8" },
      VS |-> { "n10", "n4", "n6", "n8" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Thu Oct 15 12:41:58 CEST 2020
