...
/\ Faulty = { "n10", "n7" }
/\ blockchain = 1
    :> [NextVS |-> { "n1", "n3", "n4", "n6", "n7", "n8" },
      VS |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      height |-> 1,
      lastCommit |-> {},
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n10", "n2", "n5", "n9" },
      VS |-> { "n1", "n3", "n4", "n6", "n7", "n8" },
      height |-> 2,
      lastCommit |-> { "n1", "n10", "n2", "n3", "n5", "n6", "n7", "n8" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n3", "n5" },
      VS |-> { "n1", "n10", "n2", "n5", "n9" },
      height |-> 3,
      lastCommit |-> { "n1", "n4", "n6", "n7", "n8" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
...
/\ now = 5
/\ nprobes = 1
/\ prevCurrent = [Commits |-> { "n1", "n2", "n5", "n9" },
  header |->
    [NextVS |-> { "n3", "n5" },
      VS |-> { "n1", "n10", "n2", "n5", "n9" },
      height |-> 3,
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n1", "n3", "n4", "n6", "n7", "n8" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n1", "n3", "n4", "n6", "n7", "n8" },
  header |->
    [NextVS |-> { "n1", "n10", "n2", "n5", "n9" },
      VS |-> { "n1", "n3", "n4", "n6", "n7", "n8" },
      height |-> 2,
...
/\ now = 5
/\ nprobes = 2
/\ prevCurrent = [Commits |-> { "n1", "n3", "n4", "n6", "n7", "n8" },
  header |->
    [NextVS |-> { "n1", "n10", "n2", "n5", "n9" },
      VS |-> { "n1", "n3", "n4", "n6", "n7", "n8" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Thu Oct 22 13:13:35 CEST 2020
