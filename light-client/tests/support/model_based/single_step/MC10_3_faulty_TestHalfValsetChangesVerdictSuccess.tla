...
/\ blockchain = 1
  ...
  @@ 4
    :> [NextVS |->
      ...
      VS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n8" },
      height |-> 4,
      lastCommit |-> { "n1", "n5", "n6", "n8", "n9" },
      time |-> 5]
    ...
    :> [Commits |->
      ...
      header |->
        [NextVS |-> { "n5", "n6", "n8" },
          ...
          time |-> 1]]
  @@ 3
    :> [Commits |-> { "n1", "n2", "n3", "n7", "n9" },
      header |->
        [NextVS |-> { "n2", "n3", "n7" },
          VS |-> { "n1", "n2", "n3", "n5", "n7", "n9" },
          height |-> 3,
          lastCommit |-> { "n2", "n3", "n5" },
          time |-> 3]]
/\ history = 0
...
/\ now = 1400
/\ nprobes = 1
/\ prevCurrent = [Commits |-> { "n1", "n2", "n3", "n7", "n9" },
  header |->
    [NextVS |-> { "n2", "n3", "n7" },
      VS |-> { "n1", "n2", "n3", "n5", "n7", "n9" },
      height |-> 3,
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n5", "n6", "n8" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n5", "n6", "n8" },
  header |->
    [NextVS |-> { "n1", "n10", "n4", "n5", "n6", "n8", "n9" },
      VS |-> { "n5", "n6", "n8" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Thu Oct 15 12:41:45 CEST 2020
