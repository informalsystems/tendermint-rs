...
/\ blockchain = 1
    :> [NextVS |-> { "n1", "n3", "n4", "n8" },
      ...
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n3", "n4", "n5", "n6", "n7", "n9" },
      VS |-> { "n1", "n3", "n4", "n8" },
      height |-> 2,
      lastCommit |-> { "n10", "n2", "n3", "n5", "n6", "n8", "n9" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n10", "n2", "n3", "n4", "n5", "n8", "n9" },
      VS |-> { "n3", "n4", "n5", "n6", "n7", "n9" },
      height |-> 3,
      lastCommit |-> { "n1", "n3", "n4" },
      time |-> 3]
  @@ 4
...
/\ now = 1400
/\ nprobes = 1
/\ prevCurrent = [Commits |-> { "n3", "n5", "n6", "n7", "n9" },
  header |->
    [NextVS |-> { "n10", "n2", "n3", "n4", "n5", "n8", "n9" },
      VS |-> { "n3", "n4", "n5", "n6", "n7", "n9" },
      height |-> 3,
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n1", "n3", "n4", "n8" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n1", "n3", "n4", "n8" },
  header |->
    [NextVS |-> { "n3", "n4", "n5", "n6", "n7", "n9" },
      VS |-> { "n1", "n3", "n4", "n8" },
      height |-> 2,
...
/\ now = 1400
/\ nprobes = 2
/\ prevCurrent = [Commits |-> { "n1", "n3", "n4", "n8" },
  header |->
    [NextVS |-> { "n3", "n4", "n5", "n6", "n7", "n9" },
      VS |-> { "n1", "n3", "n4", "n8" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Fri Nov 06 10:05:39 UTC 2020
