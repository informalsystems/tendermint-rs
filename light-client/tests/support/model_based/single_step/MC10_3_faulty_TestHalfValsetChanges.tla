...
/\ blockchain = 1
    :> [NextVS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n9" },
      ...
      time |-> 1]
  @@ 2
    :> [NextVS |-> { "n1", "n2", "n3", "n7", "n8" },
      VS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n9" },
      height |-> 2,
      lastCommit |-> { "n1", "n10", "n2", "n3", "n4", "n5", "n8" },
      time |-> 2]
  @@ 3
    :> [NextVS |-> { "n3", "n4", "n6", "n7", "n8", "n9" },
      VS |-> { "n1", "n2", "n3", "n7", "n8" },
      height |-> 3,
      lastCommit |-> { "n10", "n3", "n4", "n5", "n7" },
      time |-> 3]
  @@ 4
    :> [NextVS |->
        { "n1", "n10", "n2", "n3", "n4", "n5", "n6", "n7", "n8", "n9" },
      VS |-> { "n3", "n4", "n6", "n7", "n8", "n9" },
      height |-> 4,
      lastCommit |-> { "n1", "n2", "n3", "n8" },
      time |-> 4]
...
/\ now = 1400
/\ nprobes = 1
/\ prevCurrent = [Commits |-> { "n1", "n2", "n3", "n7" },
  header |->
    [NextVS |-> { "n3", "n4", "n6", "n7", "n8", "n9" },
      VS |-> { "n1", "n2", "n3", "n7", "n8" },
      height |-> 3,
        ...
        [Commits |->
          ...
          header |->
            [NextVS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n9" },
              ...
              lastCommit |-> {},
              time |-> 1]]]
/\ latestVerified = [Commits |-> { "n10", "n3", "n5", "n6", "n9" },
  header |->
    [NextVS |-> { "n1", "n2", "n3", "n7", "n8" },
      VS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n9" },
      height |-> 2,
...
/\ now = 1400
/\ nprobes = 2
/\ prevCurrent = [Commits |-> { "n10", "n3", "n5", "n6", "n9" },
  header |->
    [NextVS |-> { "n1", "n2", "n3", "n7", "n8" },
      VS |-> { "n10", "n3", "n4", "n5", "n6", "n7", "n9" },
      height |-> 2,
...
================================================================================
\* Created by Apalache on Thu Oct 15 12:41:30 CEST 2020
