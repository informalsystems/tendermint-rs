...
* For each test, it's relevant files are also saved in the subdirectory of [_test_run](_test_run). 
  ...
  * [TLA+ counterexample](_test_run/MC4_4_faulty.json/MC4_4_faulty_TestSuccess.tla), 
  the counterexample produced by Apalache in `TLA+` format
  * [JSON test fixture](_test_run/MC4_4_faulty.json/MC4_4_faulty_TestSuccess.json), 
