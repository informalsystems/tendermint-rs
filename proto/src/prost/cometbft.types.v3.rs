...
pub struct ConsensusParams {
    ...
    pub block: ::core::option::Option<super::v2::BlockParams>,
    ...
    pub version: ::core::option::Option<super::v2::VersionParams>,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Vote {
    #[prost(enumeration = "super::v1::SignedMsgType", tag = "1")]
    pub r#type: i32,
    #[prost(int64, tag = "2")]
    ...
    /// zero if vote is nil.
    #[prost(message, optional, tag = "4")]
    pub block_id: ::core::option::Option<super::v1::BlockId>,
    #[prost(message, optional, tag = "5")]
...
pub struct ExtendedCommitSig {
    #[prost(enumeration = "super::v1::BlockIdFlag", tag = "1")]
...
pub mod evidence {
    ...
    pub enum Sum {
        ...
        LightClientAttackEvidence(super::super::v1::LightClientAttackEvidence),
    }
}
...
pub struct Block {
    #[prost(message, optional, tag = "1")]
    pub header: ::core::option::Option<super::v1::Header>,
    #[prost(message, optional, tag = "2")]
    pub data: ::core::option::Option<super::v1::Data>,
    #[prost(message, optional, tag = "3")]
    pub evidence: ::core::option::Option<EvidenceList>,
    #[prost(message, optional, tag = "4")]
    pub last_commit: ::core::option::Option<super::v1::Commit>,
}
