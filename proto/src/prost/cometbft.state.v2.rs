...
pub struct AbciResponses {
    ...
    pub deliver_txs: ::prost::alloc::vec::Vec<super::super::abci::v2::ResponseDeliverTx>,
    #[prost(message, optional, tag = "2")]
    pub end_block: ::core::option::Option<super::super::abci::v2::ResponseEndBlock>,
    #[prost(message, optional, tag = "3")]
    pub begin_block: ::core::option::Option<super::super::abci::v2::ResponseBeginBlock>,
}
