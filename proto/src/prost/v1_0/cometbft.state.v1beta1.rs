...
pub struct AbciResponses {
    ...
    pub deliver_txs: ::prost::alloc::vec::Vec<
        super::super::abci::v1beta1::ResponseDeliverTx,
    >,
    #[prost(message, optional, tag = "2")]
    pub end_block: ::core::option::Option<super::super::abci::v1beta1::ResponseEndBlock>,
    #[prost(message, optional, tag = "3")]
    pub begin_block: ::core::option::Option<
        super::super::abci::v1beta1::ResponseBeginBlock,
    >,
}
...
pub struct ConsensusParamsInfo {
    ...
    pub consensus_params: ::core::option::Option<
        super::super::types::v1beta1::ConsensusParams,
    >,
    #[prost(int64, tag = "2")]
    pub last_height_changed: i64,
}
