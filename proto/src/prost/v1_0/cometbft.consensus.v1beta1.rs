...
pub struct NewValidBlock {
    ...
    pub block_parts: ::core::option::Option<super::super::libs::bits::v1beta1::BitArray>,
    #[prost(bool, tag = "5")]
    pub is_commit: bool,
}
...
pub struct ProposalPol {
    ...
    #[prost(message, optional, tag = "3")]
    pub proposal_pol: ::core::option::Option<
        super::super::libs::bits::v1beta1::BitArray,
    >,
}
...
pub struct VoteSetBits {
    ...
    pub votes: ::core::option::Option<super::super::libs::bits::v1beta1::BitArray>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Message {
