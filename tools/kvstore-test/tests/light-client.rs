...
async fn make_instance(peer_id: PeerId, options: LightClientOptions, address: rpc::Url) -> Instance<CryptoManager> {
...
async fn make_supervisor() -> Supervisor<CryptoManager> {
