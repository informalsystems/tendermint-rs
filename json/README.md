...
Crate for serializing/deserializing [Tendermint] data structures to/from JSON
(or other formats supported by [serde]).
...
[crate-image]: https://img.shields.io/crates/v/tendermint-json.svg
[crate-link]: https://crates.io/crates/tendermint-json
[docs-image]: https://docs.rs/tendermint-json/badge.svg
[docs-link]: https://docs.rs/tendermint-json/
