...
/// Serialize into a hexadecimal string, deserialize from a hexadecimal string
pub mod hexstring {
    use serde::{Deserialize, Deserializer, Serializer};
    use subtle_encoding::hex;

    /// Deserialize a hexadecimal string into Vec<u8>
    ...
    /// Serialize from T into a hexadecimal string
