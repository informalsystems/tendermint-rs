...
use crate::client::transport::router::{
    PublishResult, SubscriptionId, SubscriptionIdRef, SubscriptionQuery,
};
use crate::v0_34::{client::subscription::SubscriptionTx, event::Event};
...
mod test {
    ...
    use super::*;
    use crate::v0_34::event::{Event, WrappedEvent};
    use crate::{
