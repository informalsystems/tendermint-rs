            ...
            "block_search_evidence" => {
                ...
                for block in result.blocks {
                    ...
                    if let Evidence::DuplicateVote(dup) = evidence {
                        assert_eq!(dup.vote_a.vote_type, vote::Type::Precommit);
                        assert_eq!(dup.vote_a.height.value(), 8009);
                        assert_eq!(dup.vote_a.round.value(), 0);
                        assert_eq!(dup.vote_b.vote_type, vote::Type::Precommit);
                        assert_eq!(dup.vote_b.height.value(), 8009);
                        assert_eq!(dup.vote_b.round.value(), 0);
