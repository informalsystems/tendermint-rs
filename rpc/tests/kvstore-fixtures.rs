        ...
        match file_name {
            "abci_info" => {
                ...
                assert_eq!(
                    ...
                    // Todo: this seems like a bug. proto::ResponseInfo::last_block_app_hash should maybe base64-decode the app hash?
                    "AAAAAAAAAAA=".as_bytes() //base64::decode("AAAAAAAAAAA=").unwrap()
                );
            ...
            "broadcast_tx_commit" => {
                ...
                // Todo: seems like a bug: RPC endpoint::broadcast::TxResult::gas_wanted and gas_used is incorrectly deserialized
